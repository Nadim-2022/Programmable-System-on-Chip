...
/* PWM */
#define PWM_ctrl__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define PWM_ctrl__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define PWM_ctrl__INTC_MASK 0x01u
#define PWM_ctrl__INTC_NUMBER 0u
#define PWM_ctrl__INTC_PRIOR_NUM 7u
#define PWM_ctrl__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define PWM_ctrl__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define PWM_ctrl__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
#define PWM_Out__0__INTTYPE CYREG_PICU2_INTTYPE0
#define PWM_Out__0__MASK 0x01u
#define PWM_Out__0__PC CYREG_PRT2_PC0
...
#define Button_isr__INTC_MASK 0x40u
#define Button_isr__INTC_NUMBER 6u
#define Button_isr__INTC_PRIOR_NUM 7u
#define Button_isr__INTC_PRIOR_REG CYREG_NVIC_PRI_6
...
#define CY_PROJECT_NAME "nadimaPSoCServo"
