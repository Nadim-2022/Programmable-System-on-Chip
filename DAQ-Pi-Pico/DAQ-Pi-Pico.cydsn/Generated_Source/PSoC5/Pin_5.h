...
#if !(CY_PSOC5A &&\
	 Pin_5__PORT == 15 && ((Pin_5__MASK & 0xC0) != 0))
...
#define Pin_5_WIDTH              2u

/* Interrupt constants */
#if defined(Pin_5__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
     ...
     *  @{
     */
        #define Pin_5_INTR_NONE      (uint16)(0x0000u)
        #define Pin_5_INTR_RISING    (uint16)(0x0001u)
        #define Pin_5_INTR_FALLING   (uint16)(0x0002u)
        #define Pin_5_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Pin_5_INTR_MASK      (0x01u) 
#endif /* (Pin_5__INTSTAT) */
...
/* SIO registers */
#if defined(Pin_5__SIO_CFG)
    #define Pin_5_SIO_HYST_EN        (* (reg8 *) Pin_5__SIO_HYST_EN)
    #define Pin_5_SIO_REG_HIFREQ     (* (reg8 *) Pin_5__SIO_REG_HIFREQ)
    #define Pin_5_SIO_CFG            (* (reg8 *) Pin_5__SIO_CFG)
    #define Pin_5_SIO_DIFF           (* (reg8 *) Pin_5__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define Pin_5_0_INTTYPE_REG 		(* (reg8 *) Pin_5__0__INTTYPE)
	#define Pin_5_1_INTTYPE_REG 		(* (reg8 *) Pin_5__1__INTTYPE)
#endif /* (Pin_5__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Pin_5_H */
