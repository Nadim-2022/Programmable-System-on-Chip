// ======================================================================
// DAQ-Pi-Pico.v generated from TopDesign.cysch
// 05/26/2024 at 02:50
...
module ADC_SAR_SEQ_v2_10_2 (
	...
	cy_clock_v1_0
		#(.id("b46898a8-7a54-49b6-9430-f55282d2d384/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("b46898a8-7a54-49b6-9430-f55282d2d384/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module top ;
    ...
    ADC_SAR_SEQ_v2_10_2 ADC_SAR_Seq_1 (
        .aclk(1'b0),
        .AIN_10(Net_18),
        .AIN_100(Net_40),
        .AIN_101(Net_41),
	...
	cy_psoc3_pins_v1_10
		#(.id("ffcb1e07-525c-444c-a432-63c4e644c502"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4e408664-e6da-46ba-a484-db9f4a8f29f0"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9c656be8-9dd3-4040-ae44-f3ff04ade575"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [1:0] tmpOE__Pin_5_net;
	wire [1:0] tmpFB_1__Pin_5_net;
	...
	assign tmpOE__Pin_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};
