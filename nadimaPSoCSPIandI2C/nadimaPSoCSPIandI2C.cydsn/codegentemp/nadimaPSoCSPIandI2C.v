// ======================================================================
// nadimaPSoCSPIandI2C.v generated from TopDesign.cysch
// 04/19/2024 at 16:24
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e9676270-3ede-4e6f-92c8-39976890e65e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_50_4 SPIM_1 (
        ...
        .mosi(Net_133),
        .reset(1'b0),
        .rx_interrupt(Net_139),
        .sclk(Net_148),
        .sdat(Net_140),
        .ss(Net_147),
        .tx_interrupt(Net_141));
	...
	cy_clock_v1_0
		#(.id("d5986368-2717-4097-898d-0f19adb86062"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e3c9ca34-524f-4f54-95ce-7fdcdb24d3c3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
